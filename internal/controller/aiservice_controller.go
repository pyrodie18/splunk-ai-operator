...
func (r *AIServiceReconciler) reconcileFluentBitConfig(ctx context.Context, p *aiv1.AIService) error {
...
func (r *AIServiceReconciler) AddFluentBitSidecar(podSpec *corev1.PodSpec, ai *aiv1.AIService) {
