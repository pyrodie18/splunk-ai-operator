...
kubectl get aiplatform  >> aiplatform.txt; kubectl get aiplatform -o yaml >> aiplatform.txt;
kubectl get aiservices  >> aiservices.txt; kubectl get aiservices -o yaml >> aiservices.txt;
...
then
   ...
   kubectl describe aiplatform > aiplatform.txt
   kubectl describe aiservices > aiservices.txt
