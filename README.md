...
```sh
make build-installer IMG=<some-registry>/splunk-ai-operator:tag
```
...
```sh
kubectl apply -f https://raw.githubusercontent.com/<org>/splunk-ai-operator/<tag or branch>/dist/install.yaml
```
